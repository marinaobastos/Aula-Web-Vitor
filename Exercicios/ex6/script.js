/*
Preciso que faça alguns ajustes no código:
1) Mostre na tabela, o ID, o nome do produto, o preço, o fabricante e o tipo de unidade.
2) O tipo de unidade deve ser: quilo, litro, unidade ou caixa.
3) Ao clicar em qualquer um dos campos a serem preenchidos (o ID, o nome do produto, o preço, o fabricante 
e o tipo de unidade) ao cadastrar um novo produto, preciso que as opções apareçam para o usuário para que 
ele selecione caso não queira escrever.
...
async function carregarProdutos() {
    ...
    try {
        ...
        produtos.forEach(produto => {
            ...
            idList.innerHTML += `<option value="${produto.id}">`;
...
async function cadastrarProduto(event) {
    ...
    if (!id || !nome || isNaN(preco) || !fabricante || !tipoUnidade) return;
    ...
    try {
        ...
        const resposta = await fetch('http://localhost:3000/produtos', {
            ...
            body: JSON.stringify({ id, nome, preco, fabricante, tipo_unidade: tipoUnidade })
        });
